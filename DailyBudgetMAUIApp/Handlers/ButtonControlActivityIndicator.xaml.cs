...
public partial class ButtonControlActivityIndicator : Frame
{
	public ButtonControlActivityIndicator()
	{
		InitializeComponent();
	}
    ...
    public static readonly BindableProperty CommandProperty = BindableProperty.Create(
        ...
        declaringType: typeof(ButtonControlActivityIndicator),
    ...
    {
        var controls = (ButtonControlActivityIndicator)bindable;
        if (newValue != null)
        {
